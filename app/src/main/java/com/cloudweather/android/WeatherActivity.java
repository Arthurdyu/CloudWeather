...
import com.cloudweather.android.gson.Forecast;
import com.cloudweather.android.gson.Weather;
import com.cloudweather.android.service.AutoUpdateService;
import com.cloudweather.android.util.HttpUtil;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarmButton=(Button)findViewById(R.id.btn_alarm);
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=913b839346944ddaa8211ee93006ec43";
